...
/*TODO:
 - [X] Create control scheme for O3DS
 */
cfg_input_def_t input_defs_o3ds[] = {
  INPUT_SETTING("input_forward", dsda_input_forward, 'w', 2, -1),
  INPUT_SETTING("input_backward", dsda_input_backward, 's', -1, -1),
  INPUT_SETTING("input_turnleft", dsda_input_turnleft, 'e', -1, DSDA_CONTROLLER_BUTTON_Y),
  INPUT_SETTING("input_turnright", dsda_input_turnright, 'q', -1, DSDA_CONTROLLER_BUTTON_A),
  ...
  INPUT_SETTING("input_nextweapon", dsda_input_nextweapon, 0, -1, DSDA_CONTROLLER_BUTTON_DPAD_UP),
  INPUT_SETTING("input_prevweapon", dsda_input_prevweapon, 0, -1, DSDA_CONTROLLER_BUTTON_DPAD_DOWN),
  INPUT_SETTING("input_toggleweapon", dsda_input_toggleweapon, '0', -1, -1),
  INPUT_SETTING("input_fire", dsda_input_fire, KEYD_RCTRL, 0, DSDA_CONTROLLER_BUTTON_RIGHTSHOULDER),

  INPUT_SETTING("input_help", dsda_input_help, KEYD_F1, -1, -1),
  INPUT_SETTING("input_pause", dsda_input_pause, KEYD_PAUSE, -1, -1),
  INPUT_SETTING("input_map", dsda_input_map, KEYD_TAB, -1, DSDA_CONTROLLER_BUTTON_LEFTSHOULDER),
...
void M_LoadDefaults (void)
{
  ...
  for (i = 0; i < input_def_count; i++) {
    ...
    if(setO3DS){
      dsda_InputSetSpecific(c, input_defs_o3ds[i].identifier, input_defs_o3ds[i].input);
    }else{
